...
\lstinputlisting[language=Coq]{res/code/uguaglianzaProposizionale/es2.v}
...
\lstinputlisting[language=Coq]{res/code/uguaglianzaProposizionale/es3.v}
%\proof
...
\lstinputlisting[language=Coq]{res/code/uguaglianzaProposizionale/es4.v}
...
\lstinputlisting[language=Coq]{res/code/uguaglianzaProposizionale/es5.v}
...
\lstinputlisting[language=Coq]{res/code/uguaglianzaProposizionale/es6.v}
...
\lstinputlisting[language=Coq]{res/code/uguaglianzaProposizionale/es8.v}
